...
public class GlobalExceptionHandler {
    ...
    public Object notFountHandler(HttpServletRequest request, NoHandlerFoundException e){
        System.err.println("PageNotFoundException:");
        return JsonResult.failed(15, "PageNotFoundException");
    }


    @ExceptionHandler({ExpiredJwtException.class, MalformedJwtException.class,SignatureException.class})
    public String jwtErrorException(){
        return JsonResult.failed(16, "Token超时或者转换错误");
